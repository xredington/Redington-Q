    ...
    return (
        <main className="flex-grow relative w-95 mx-auto flex flex-col pb-6">
            <div className="flex items-center justify-center gap-5 mr-auto">
                <h1 className="text-2xl sm:text-4xl my-10"><span className="text-green-600">Q</span>Chat</h1>
            </div>
            <section className={"grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto auto-rows-[15rem] lg:auto-rows-[13.5rem]"}>
                {Brands.map((brand) => (
